        ...
        <form id="feedback-form" method="post" enctype="multipart/form-data" novalidate action="">
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input id="login" type="text" name="form[login]" class="form-control" value="<?php echo !empty($_POST['form']['login']) ? $_POST['form']['login'] : FALSE;?>" placeholder="Логін" minlength="2"
                           maxlength="30" required="required">
                    <i class="info">Лише символи латиниці и кирилиці</i>
                    <span class="error">* <?php echo !empty($pageData['errors']['login']) ? $pageData['errors']['error_login'] : FALSE;?></span>
                    <div class="invalid-feedback"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="password" type="text" name="form[password]" required="required" class="form-control" value="<?php echo !empty($_POST['form']['password']) ? $_POST['form']['password'] : FALSE;?>"
                           placeholder="Пароль">
                    <span class= "error" >* <?php echo !empty($pageData['errors']['error_password']) ? $pageData['errors']['error_password'] : FALSE;?></span>
                    <div class="invalid-feedback"></div>
                </div>
